...
const Header = () => {
    ...
    return (
        <div className="p-3 md:p-8 bg-gradient-to-b from-black w-full flex justify-between items-center absolute md:fixed top-0 z-30">
            <h1 className="text-2xl md:text-4xl font-black text-orange-500 tracking-tighter cursor-pointer">
    ORIZON
</h1>
            ...
            {user && <div className="flex md:p-4 items-center text-sm md:text-base xl:text-sm 2xl:text-base">
                ...
                {!gptPageState && <button className="md:font-bold text-white mr-3 md:mr-6 py-1 md:py-2 px-2 md:px-4 cursor-pointer gradient-border bg-gray-900 active:bg-gray-700" onClick={toggleGptPage}>✦ Orizon Discovery</button>}
                {gptPageState && <button className="md:font-bold text-white mr-3 md:mr-6 py-1 md:py-2 px-2 md:px-4 cursor-pointer bg-orange-500 active:bg-orange-700 rounded-lg" onClick={toggleGptPage}>Home</button>}
